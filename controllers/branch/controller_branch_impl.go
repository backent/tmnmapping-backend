...
type ControllerBranchImpl struct {
	service servicesBranch.ServiceBranchInterface
}

func NewControllerBranchImpl(service servicesBranch.ServiceBranchInterface) ControllerBranchInterface {
	return &ControllerBranchImpl{service: service}
}

func (c *ControllerBranchImpl) Create(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
	request := r.Context().Value(helpers.ContextKey("createBranchRequest")).(webBranch.CreateBranchRequest)
...
func (c *ControllerBranchImpl) FindAll(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
	var request webBranch.BranchRequestFindAll
...
func (c *ControllerBranchImpl) FindById(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
...
func (c *ControllerBranchImpl) Update(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
	id := r.Context().Value(helpers.ContextKey("branchId")).(int)
	request := r.Context().Value(helpers.ContextKey("updateBranchRequest")).(webBranch.UpdateBranchRequest)
	resp := c.service.Update(r.Context(), request, id)
	helpers.ReturnReponseJSON(w, web.WebResponse{Status: "OK", Code: http.StatusOK, Data: resp})
}

func (c *ControllerBranchImpl) Delete(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
	id, err := strconv.Atoi(p.ByName("id"))
	if err != nil {
		panic(exceptions.NewBadRequest("invalid branch id"))
	}
	c.service.Delete(r.Context(), id)
	helpers.ReturnReponseJSON(w, web.WebResponse{Status: "OK", Code: http.StatusOK, Data: "Branch deleted successfully"})
}

func (c *ControllerBranchImpl) FindAllDropdown(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
	var request webBranch.BranchRequestFindAll
...
func (c *ControllerBranchImpl) Import(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
...
func (c *ControllerBranchImpl) Export(w http.ResponseWriter, r *http.Request, p httprouter.Params) {
	search := r.URL.Query().Get("search")

	excelBytes, err := c.service.Export(r.Context(), search)
	helpers.PanicIfError(err)

	filename := "Branch_Export_" + time.Now().Format("02-01-2006") + ".xlsx"
